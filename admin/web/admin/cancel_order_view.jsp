...
<c:if test="${param.cancel_order_id == null}">
...
<jsp:include page="admin_header.jsp"/>
 <sql:query dataSource="${db}" var="order_detail">
      SELECT * FROM `cancel_order_detail` WHERE `cancel_order_id`='${param.cancel_order_id}' 
    </sql:query>
...
<h2 class="title1458">Cancel Order Id : ${param.cancel_order_id}</h2>
...
<tr>
<td>${order_detail_list.cancel_order_detail_id}</td>
<td>
...
<td class="text-center">${order_detail_list.product_quantity}</td>
