    ...
    <main>
        <div class="container-fluid">
            ...
            <div class="row justify-content-between">
                 <c:set value="SELECT * FROM `order_master` ORDER BY `invoice_no` DESC;" var="select_query_order" scope="session"/>
                                            ...
                                            <c:when test="${select_query2 != null}">
                                                <c:catch var="exception">
                                                    <sql:query var="order_master" dataSource="${db}">
                                                        SELECT * FROM `order_master` WHERE `date`='${select_query2}' ORDER BY `invoice_no` DESC;
                                                    </sql:query>
