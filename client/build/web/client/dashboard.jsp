...
<a href="dashboard_my_cancel_orders.jsp" class="user-item"><i class="uil uil-gift"></i>My Canceled Orders</a>
...
<div class="col-lg-12 col-md-12">
     <sql:query dataSource="${db}" var="select_order">
        SELECT * FROM `order_master` WHERE `user_name`='${user_name}'
    </sql:query>
...
<c:if test="${time_left.rowCount > 0}">
    <form>
    <a class="button button3" href='cancel_order_view.jsp?invoice_no=${order_list.invoice_no}'>Cancel Order Within 30 Minutes Of Your Purchase</a>
    </form>
